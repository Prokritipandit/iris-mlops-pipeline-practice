...
def dvc_pulled_model():
    ...
    Assumes 'dvc pull' has ALREADY been run by the CI pipeline.
    """
    # FIX: Define relative paths
    model_path = "models/model.joblib"
    encoder_path = "models/label_encoder.joblib"

    # FIX: REMOVED the os.system("dvc pull...") line.
    # The CI pipeline already does this.
...
def evaluation_data(feast_store):
    ...
    ground_truth_path = "data/iris_ground_truth.csv"
...
# --- TESTS --- (No changes needed below this line)
